...
/**
 * Generate PDF bill for pathology test booking
 * @param {Object} booking - PathologyTestBooking document with populated fields
 ...
 */
async function generatePathologyBillPDF(booking, hospital, patient, doctor, bill, createdBy) {
  return new Promise((resolve, reject) => {
    try {
      ...
      // Bill Title
      doc.moveDown(1);
      doc.fontSize(16).font('Helvetica-Bold').text('PATHOLOGY TEST BILL', { align: 'center' });
      ...
      drawTableBox(doc, [
        ...
        { label: 'Discount:', value: `₹${booking.discount || 0}` },
...
module.exports = { generatePathologyBillPDF };
